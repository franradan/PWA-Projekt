...
<?php require_once "header.php" ?>
    ...
    <?php
        ...
        $query = "SELECT * FROM articles WHERE archive = 0 AND category = 'melee' ORDER BY id DESC LIMIT 4";
    ...
    <?php
        ...
        $query = "SELECT * FROM articles WHERE archive = 0 AND category = 'ranged' ORDER BY id DESC LIMIT 4";
        $result = mysqli_query($dbc, $query);
